 ...
 * Format: CS-XXXXXX (e.g. CS-A7K29X, CS-M82PQL, CS-X91K2A)
 */
 ...
 * Format: CS-BATCH-YYYYMMDD-001 or CS-BATCH-YYYYMMDD-XXX
...
export function generateBatchCode(sequence) {
  ...
  if (sequence !== undefined && sequence !== null && !isNaN(Number(sequence))) {
    return `CS-BATCH-${dateStr}-${String(sequence).padStart(3, '0')}`;
  }
