...
export async function ensureDatabaseInitialized() {
  ...
  _initPromise = (async () => {
    try {
      ...
      // Extremely important performance optimization for Vercel serverless:
      // Do NOT run massive DDL statements on every lambda cold start in production.
      ...
      const initSql = `
        ...
        CREATE INDEX IF NOT EXISTS idx_ratings_business_id ON ratings(business_id);
      `;
