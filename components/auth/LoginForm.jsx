...
import { Wifi, ShieldCheck, Coffee, ArrowRight } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg border-slate-200/90">
          ...
          >
            ...
            <span>{isLoadingGoogle ? 'Menghubungkan...' : 'Continue with Google'}</span>
          </button>
          ...
          <div className="space-y-2">
            <p className="text-[11px] text-slate-500 text-center mb-2">
              Pilih akun untuk mencoba alur secara langsung:
            </p>
            ...
            >
              <button
                type="submit"
                className="w-full flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:border-brand-500 hover:bg-brand-50/50 transition-all text-left text-xs"
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="font-semibold text-slate-800">Login sebagai ADMIN</div>
                    <div className="text-[10px] text-slate-500">admin@smartwifi.com (Akses /admin)</div>
                  </div>
                </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="font-semibold text-slate-800">Login Customer (Kopi Senja)</div>
                    <div className="text-[10px] text-slate-500">ahmad@kopisenja.com (Pemilik Kafe)</div>
                  </div>
                </div>
                <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
              </button>
